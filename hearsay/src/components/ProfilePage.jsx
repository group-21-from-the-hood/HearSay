      ...
      <div className="max-w-2xl mx-auto border-2 border-black dark:border-white bg-white dark:bg-gray-900">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border-2 border-black dark:border-white p-4">
            <h2 className="font-semibold text-black dark:text-white mb-2">Basic Info</h2>
          ...
          <div className="border-2 border-black dark:border-white p-4">
            <h2 className="font-semibold text-black dark:text-white mb-2">connected accounts</h2>
